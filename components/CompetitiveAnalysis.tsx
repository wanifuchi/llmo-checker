...
export default function CompetitiveAnalysisComponent({ analysis }: CompetitiveAnalysisProps) {
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        >
          <div className="flex items-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900">市場ポジション</h3>
          </div>
              ...
              <div key={index} className="border rounded-lg p-4">
                ...
                <div className="grid grid-cols-3 gap-4 text-sm">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-xs text-gray-500">競合平均</div>
                  </div>
                  <div className="text-center">
                    <div className="text-lg font-medium text-green-600">
                      {gap.topCompetitorScore.toFixed(1)}
                    </div>
                    <div className="text-xs text-gray-500">トップ競合</div>
                  </div>
                </div>
